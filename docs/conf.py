...
"""
edx_exams documentation build configuration file.
...
VERSION = get_version('../edx_exams', '__init__.py')
...
html_context = {
    ...
    "github_repo": 'edx_exams',  # Repo name
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Service providing access to exam information',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx_exams'),
                os.path.join(root_path, 'edx_exams/migrations')])
